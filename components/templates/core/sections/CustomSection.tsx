...
export const CustomSection: React.FC<CustomSectionProps> = ({
  ...
  const styles = StyleSheet.create({
    ...
    name: {
      fontSize: fontSize + 1,
      fontFamily: settings.customSectionNameBold ? fonts.bold : settings.customSectionNameItalic ? fonts.italic : fonts.base,
    ...
    date: {
      fontSize,
      fontFamily: settings.customSectionDateBold ? fonts.bold : settings.customSectionDateItalic ? fonts.italic : fonts.base,
    ...
    description: {
      fontSize,
      fontFamily: settings.customSectionDescriptionBold ? fonts.bold : settings.customSectionDescriptionItalic ? fonts.italic : fonts.base,
    ...
    url: {
      fontSize: fontSize - 1,
      fontFamily: settings.customSectionUrlBold ? fonts.bold : settings.customSectionUrlItalic ? fonts.italic : fonts.base,
      fontWeight: settings.customSectionUrlBold ? "bold" : "normal",
      fontStyle: settings.customSectionUrlItalic ? "italic" : "normal",
      color: linkColor,
      marginTop: 2,
    },
    summary: {
